        ...
        for row1 in range(4):
            for column1 in range(4):
                ...
                if value != 0:
                    ...
                    manhattan_distance_sum += (abs(diff_x) + abs(diff_y)) / 3.0  # Divide by 3 for admissible heuristic
                ...
                if i == self.row and j == self.column:
                    ...
                    while r_copy > 0:
                        if r_copy == 1:
                            ...
                            move = "D" + str(r_copy) + str(self.row + 1)  # sequence of moves string builder
